...
CREATE TABLE `booked_vehicles` (
  ...
  CONSTRAINT `renteid` FOREIGN KEY (`vehicleid`) REFERENCES `Vehicles` (`vehicleid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
LOCK TABLES `booked_vehicles` WRITE;
/*!40000 ALTER TABLE `booked_vehicles` DISABLE KEYS */;
/*!40000 ALTER TABLE `booked_vehicles` ENABLE KEYS */;
UNLOCK TABLES;
